...
from pydantic import BaseModel, Discriminator, GetJsonSchemaHandler, Tag, WrapSerializer
from pydantic.json_schema import JsonSchemaValue
import pydantic_core.core_schema as core_schema
from typing import _SpecialForm, Annotated, Any, Iterable, Union as _Union, get_args, get_origin
